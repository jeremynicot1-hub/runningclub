  ...
  return (
    <div className="kinetic-topbar">
      ...
      <div style={{ display: 'flex', gap: 20, alignItems: 'center', color: 'var(--ks-text-muted)' }}>
        ...
        <Link href="/dashboard/profile" style={{ width: 32, height: 32, borderRadius: '50%', background: '#eee', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', color: 'inherit', border: '1px solid var(--ks-border)' }}>
